    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Created", "Category_name", "Updated" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 30, 10, 57, 0, 115, DateTimeKind.Utc).AddTicks(4894), "Bilgisayar", null },
                    { 2, new DateTime(2025, 1, 30, 10, 57, 0, 115, DateTimeKind.Utc).AddTicks(4897), "Telefon", null }
                });
